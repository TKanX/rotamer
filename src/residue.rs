...
/// Invokes `$cb!(Type)` for each of the 29 sidechain types.
///
/// The callback macro receives a single identifier token (e.g. `Ser`)
/// and can access associated constants via `<$Type as Sidechain>::N_CHI`
/// and similar paths.
///
/// # Examples
///
